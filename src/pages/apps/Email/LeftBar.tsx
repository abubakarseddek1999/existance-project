        ...
        <div className="d-flex">
          ...
          <div className="flex-grow-1">
            ...
            <small className="text-white-50">
              <i className="uil uil-circle fs-11 text-success me-1"></i>Active
              Now
            </small>
          </div>
          <div className="float-end fs-18 mt-1">
            ...
            <Link
              to="#"
              className="chat-close text-white"
              onClick={handleClose}
            >
    ...
    <>
      <div className="mail-list mt-4">
        <Link to="#" className="list-group-item border-0 text-danger fw-bold">
          ...
          <span className="badge bg-danger float-end ms-2 mt-1">
            {totalUnreadEmails}
          </span>
        </Link>
      ...
      <div className="list-group border-0 mail-list">
        <Link to="#" className="list-group-item border-0">
          <span className="uil uil-circle text-primary fs-12 me-1"></span>Web
          App
        </Link>
        <Link to="#" className="list-group-item border-0">
        ...
        <Link to="#" className="list-group-item border-0">
          <span className="uil uil-circle text-success fs-12 me-1"></span>Wallet
          Balance
        </Link>
        <Link to="#" className="list-group-item border-0">
            ...
            <div className="d-flex">
              ...
              <div className="flex-grow-1 overflow-hidden">
                ...
                <small className="text-muted">
                  <i className="uil uil-circle fs-11 text-success"></i> Active
                  Now
                </small>
              </div>
