          ...
          <Card>
            <Card.Body>
              ...
              <p className="mb-3">
                Use{" "}
                <code>
                  &lt;FeatherIcon icon="activity" className="icon-**" /&gt;
                </code>
                . Available sizes <code>sm,md,lg,xl,xxl</code>
              </p>
              ...
              <Row className="icons-list">
                ...
                <Col sm={6} lg={4} xl={3}>
                  <div className="icon-item">
                    <FeatherIcon icon="airplay" className="icon-sm icon-dual" />{" "}
                    <span>Small</span>
                  </div>
                </Col>
                <Col sm={6} lg={4} xl={3}>
                  <div className="icon-item">
                    <FeatherIcon icon="airplay" className="icon-lg icon-dual" />{" "}
                    <span>Large</span>
                  </div>
                </Col>
                <Col sm={6} lg={4} xl={3}>
