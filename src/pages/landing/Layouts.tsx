      ...
      <Container>
          ...
          <Col lg={12}>
            <div className="text-center">
              ...
              <p className="text-muted mt-2 fs-15">
                Multiple navigation layouts and navigation color schemes are
                available to cater need of any modern web application. <br />
                We understand that having only html bundle is not enough and so
                we have developed the React, Angular, Vue and Laravel versions
                as well.
              </p>
            </div>
          </Col>
        ...
        <Row className="mt-2 pb-3">
          <Col className="text-center">
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id={`tooltip-html`}>Html 5</Tooltip>}
            >
              <img src={brand2} alt="" height="48" className="m-1" />
            </OverlayTrigger>
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id={`tooltip-css`}>CSS 3</Tooltip>}
            >
            ...
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id={`tooltip-scss`}>SCSS</Tooltip>}
            >
              <img src={brand5} alt="" height="48" className="m-1" />
            </OverlayTrigger>
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id={`tooltip-gulp`}>Gulp v4</Tooltip>}
            >
              <img src={brand6} alt="" height="48" className="m-1" />
            </OverlayTrigger>
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id={`tooltip-yarn`}>Yarn</Tooltip>}
            >
              ...
              <Col key={index} xl={4} md={6}>
                <Card className="border-0">
                  <Card.Body className="shadow-none text-center">
                    <Link
                      to={{ pathname: item.pageUrl }}
                      onClick={() => getLayoutConfig(item.name)}
                      rel="noreferrer"
