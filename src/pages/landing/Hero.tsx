      ...
      <Container>
        <Row className="align-items-center">
          <Col className="text-center">
            <div className="py-4">
              <h1 className="mb-4">
                Build your dashboard or admin application faster with Shreyu
              </h1>

              <p className="mb-3 fs-16 text-center">
                Shreyu is a fully featured admin and dashboard template. Shreyu
                comes with tones of well designed & ready to use <br />
        ...
        <Row>
          <Col>
            <img
              src={verticalImg}
              alt=""
              className="mx-auto d-block shadow img-fluid"
            />
          </Col>
        </Row>
      </Container>
