        ...
        <Row className="mt-5 mb-3">
          <Col lg={{ span: 5, offset: 1 }}>
            <div>
              ...
              <p className="faq-answer mb-4 pb-1 text-muted fs-15">
                ...
                end product.For more information on licenses, please refer here
              </p>
            </div>
          ...
          <Col lg={5}>
            <div>
              ...
              <p className="faq-answer mb-4 pb-1 text-muted fs-15">
                No. This is a HTML template. It won't work directly with
                wordpress. However you can convert this into wordpress
                compatible theme.
              </p>
            </div>
            ...
            <div className="pt-3">
              ...
              <p className="faq-answer mb-4 pb-1 text-muted fs-15">
                Yes, We will update the Shreyu regularly. All the future updates
