        ...
        <Row className="pb-3">
          <Col lg={12}>
            <div className="text-center">
              <h1>
                Complete UI Kit with{" "}
                <span className="text-primary">Reusable Widgets</span>
              </h1>
              <p className="text-muted mt-2">
                Fully responsive and resuable widgets covering statistics, user
                profile, team, chat, tasks, etc.
              </p>
            </div>
          </Col>
        </Row>
